public class Room {
    ...
    public void draw(Gui gui) {
        ...
        gui.drawLine(0, this.height - 1, this.width - 1, this.height - 1, WALL_CHARACTER, FOREGROUND_COLOR, BACKGROUND_COLOR);
        
        gui.drawLine(0, 1, 0, this.height - 1, WALL_CHARACTER, FOREGROUND_COLOR, BACKGROUND_COLOR);
        
        gui.drawLine(this.width - 1, 0, this.width - 1, this.height - 1, WALL_CHARACTER, FOREGROUND_COLOR, BACKGROUND_COLOR);
    }
}
